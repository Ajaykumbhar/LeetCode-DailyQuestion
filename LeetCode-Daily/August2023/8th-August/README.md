...
### Understanding the Rotated Array:
  ...
  This means that the array is divided into two segments, each of which is sorted.
  For instance, consider the array [4, 5, 6, 6, 7, 0, 1, 2, 4, 4].
  This array can be divided into two sorted segments: [4, 5, 6, 6, 7] and [0, 1, 2, 4, 4].
